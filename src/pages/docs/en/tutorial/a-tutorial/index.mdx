...
Internal links look like this: [A Second Tutorial](/docs/en/tutorial/a-second-tutorial/)

External links indicate they point to an external page with an icon: [Google](https://google.com)
